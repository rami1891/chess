...
/**
    ...
    private Collection<ChessMove> pawnMoves(ChessBoard board, ChessPosition myPosition) {
        ...
        if (pieceColor == ChessGame.TeamColor.WHITE) {
            pawnMoves[0] = (board.getPiece(new ChessPosition(row + 1, col)) == null) ? new ChessPosition(row + 1, col) : null;
            pawnMoves[1] = (col < 8 && board.getPiece(new ChessPosition(row + 1, col + 1)) != null && board.getPiece(new ChessPosition(row + 1, col + 1)).getTeamColor() != this.pieceColor) ? new ChessPosition(row + 1, col + 1) : null;
            pawnMoves[2] = (col > 1 && board.getPiece(new ChessPosition(row + 1, col - 1)) != null && board.getPiece(new ChessPosition(row + 1, col - 1)).getTeamColor() != this.pieceColor) ? new ChessPosition(row + 1, col - 1) : null;
        ...
        if (row == 2 && board.getPiece(myPosition).pieceColor == ChessGame.TeamColor.BLACK || row == 7 && board.getPiece(myPosition).pieceColor == ChessGame.TeamColor.WHITE) {
            for (ChessPosition pawn : pawnMoves) {
                if(pawn != null) {
                    moves.add(new ChessMove(myPosition, pawn, ChessPiece.PieceType.QUEEN));
                    moves.add(new ChessMove(myPosition, pawn, ChessPiece.PieceType.ROOK));
                    moves.add(new ChessMove(myPosition, pawn, ChessPiece.PieceType.BISHOP));
                    moves.add(new ChessMove(myPosition, pawn, ChessPiece.PieceType.KNIGHT));
                }
            }
        }
        else {
            for (ChessPosition pawn : pawnMoves) {
                ...
                moves.add(new ChessMove(myPosition, pawn, null));
            }
        }
        return moves;
    }
